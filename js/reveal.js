...
var Reveal = (function(){
  ...
  function createBackgrounds() {
    ...
    // given slide
    function _createBackground( slide, container, isVerticalContainer ) {
      ...
      element.className = 'slide-background vertical';
    ...
    toArray( document.querySelectorAll( HORIZONTAL_SLIDES_SELECTOR ) ).forEach( function( slideh ) {
      ...
      var verticalSlides = toArray( slideh.querySelectorAll( 'section' ) );
      var hasVerticalSlides = verticalSlides.length ? true : false;

      if( isPrintingPDF() ) {
        backgroundStack = _createBackground( slideh, slideh, hasVerticalSlides );
      }
      else {
        backgroundStack = _createBackground( slideh, dom.background, hasVerticalSlides );
      }
      
      verticalSlides.forEach( function( slidev ) {
  ...
  function updateBackground() {
    ...
    toArray( dom.background.childNodes ).forEach( function( backgroundh, h ) {
      ...
      var backgroundClasses = 'slide-background';
      backgroundClasses += ' '  + ( h < indexh ? horizontalPast : h > indexh ? horizontalFuture : 'present' );

      var verticalClass = 'vertical-container';
      if (backgroundh.classList.contains(verticalClass)) {
        backgroundClasses += ' ' + verticalClass;
      }

      backgroundh.className = backgroundClasses;
